...
```{r, echo=FALSE}
#img <- readPNG("IMG_1553.png", info = TRUE)
#grid.raster(img, hjust = 0.47 , height = 1.02)
```

![*Above:* A photo I took from the North Stand at the **Tottenham** **Hotspur** **Stadium** in 2019 after a 1-0 win against Brighton, in which **Christian** **Eriksen** scored the only goal.](IMG_1553.png)
